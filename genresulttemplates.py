...
<head>
  <link type="text/css" rel="stylesheet" href="/stylesheets/main.css" />
    ...
    <td>
    <form action="/addgenresult" method="get">
...
ADD_GENRESULT_TEMPLATE = """\
<head>
  <link type="text/css" rel="stylesheet" href="/stylesheets/main.css" />
</head>
    <form action="/doaddgenresult" method="post">
      <div><textarea name="genresultname"    rows="1" cols="40"></textarea></div>
      <div><textarea name="genresultscript"  rows="1" cols="40"></textarea></div>
      <div><textarea name="genresultniter"   rows="1" cols="40"></textarea></div>
      <div><input type="submit" value="Add"></div>
    </form>
    <hr>
    <form action="/" method="get">
